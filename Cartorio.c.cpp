...
#include <string.h> //biblioteca responsavel de cuidar do string
...
int registro() // Função responsavel por cadastrar usuarios no sistema
{
   // inicio da criação de variáveis/string 
	...
	strcpy (arquivo, cpf); //Responsavel para copiar os valores das string
...
int deletar()
{
	...
	printf("Digite o CPF a se deletado: ");
	scanf("%s", cpf);
